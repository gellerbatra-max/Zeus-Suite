// Same local-dev auth stand-in as every other app in the suite -- type an identity instead of a
// real Entra ID login. format-interchange-service forwards these headers through to
