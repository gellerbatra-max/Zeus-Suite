"""format-interchange-service: IGES piece export + import + legacy migration batch classification
(Steps 1-3 of format_interchange_plan.md Sec 7). Unlike pattern-design-service/marker-making-service,
this app owns a real database (Sec 4) -- see app/db.py's docstring."""
...
from app.api import export, import_, import_profiles, migration
